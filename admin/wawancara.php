...
include '../koneksi.php';
$siswa = mysqli_query($koneksi, "SELECT jurusan.jurusan, gelombang.gelombang, peserta_pelatihan.* FROM peserta_pelatihan LEFT JOIN gelombang ON gelombang.id = peserta_pelatihan.id_gelombang LEFT JOIN jurusan ON jurusan.id = peserta_pelatihan.id_jurusan  WHERE peserta_pelatihan.status = 2 ORDER BY id DESC");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="card">
                                <h5 class="card-header">Data Wawancara</h5>
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            while ($rowSiswa = mysqli_fetch_assoc($siswa)) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="wawancara.php?edit=<?php echo $rowSiswa['id'] ?>" class="<?php echo $rowSiswa['status'] == 2 ? 'btn btn-warning' : 'btn btn-success' ?>"><?php echo $rowSiswa['status'] == 2 ? 'Wawancara' : 'Lolos' ?></a></td>
                                                    <td>| <a href=" https://wa.me/<?php echo $rowSiswa['id'] ?>" target="_blank"><i class='bx bxl-whatsapp'></i></a> | | <a href="lulus.php"><i class='bx bx-edit'></i> |</a><a><a href=" details-siswa.php?edit=<?php echo $rowSiswa['id'] ?>"><i class='bx bx-dots-vertical'></i></a></td>
                                                    </td>
                                                </tr>
                                            <?php endwhile ?>
                                        </tbody>
