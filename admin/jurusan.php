...
if (isset($_GET['delete'])) {
    ...
    header("location: jurusan.php?delete=berhasil");
}
                        ...
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <div align="right">
                                        <a href="add_jurusan.php" class="btn btn-success"><i class="fa-solid fa-square-plus"></i>Tambah</a>
                                    </div>
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            while ($row = mysqli_fetch_assoc($query)) : ?>
                                                <tr>
                                                    ...
                                                    <td>| <a href="add_jurusan.php?edit=<?php echo $row['id'] ?>"><i class='bx bx-edit-alt'></i></a> | | <a href="jurusan.php?delete=<?php echo $row['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"><i class='bx bx-trash'></i> |</a></td>
                                                    </td>
                                                </tr>
                                            <?php endwhile ?>
                                        </tbody>
