...
function convertStatus($status)
{
    switch ($status) {
        ...
        default:
            $labelStatus = '<span class="badge badge-warning">Tidak Aktif</span>';
            break;
    }
    return $labelStatus;
}
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="card">
                                <h5 class="card-header">Gelombang</h5>
                                <div class="table-responsive text-nowrap">
                                    <div align="right">
                                        <a href="add_gelombang.php" class="btn btn-success"><i class="fa-solid fa-square-plus"></i>Tambah</a>
                                    </div>
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            while ($row = mysqli_fetch_assoc($query)) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo convertStatus($row['status']) ?></td>
                                                    <td>| <a href="add_gelombang.php?edit=<?php echo $row['id'] ?>"><i class='bx bx-edit-alt'></i></a> | | <a href="gelombang.php?delete=<?php echo $row['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"><i class='bx bx-trash'></i> |</a></td>
                                                    </td>
                                                </tr>
                                            <?php endwhile ?>
                                        </tbody>
