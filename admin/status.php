...
if (isset($_GET['edit'])) {
    ...
    header("location: status.php?status-diubah");
}
// 
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            while ($rowSiswa = mysqli_fetch_assoc($siswa)) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="status.php?edit=<?php echo $rowSiswa['id'] ?>" class="<?php echo $rowSiswa['status'] == 0 ? 'btn btn-warning' : 'btn btn-success' ?>"><?php echo $rowSiswa['status'] == 0 ? 'Verifikasi' : 'Lolos' ?></a></td>
