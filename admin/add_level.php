...
if (isset($_POST['tambah'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO level (level) VALUES ('$level')");
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE level SET level='$level' WHERE id='$id'");
    header("location: level.php?edit=berhasil");
}
                                ...
                                <fieldset class="border border-2 p-3" style="border-width: 2px; border-color: black; border-style: solid;">
                                    ...
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="level" placeholder="Masukkan level" value="<?php echo isset($_GET['edit']) ? $rowLvl['level'] : '' ?>">
                                        </div>
                                        <div class="mb-3">
