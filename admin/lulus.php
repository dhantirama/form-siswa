...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $update = mysqli_query($koneksi, "UPDATE peserta_pelatihan SET status = 3 WHERE id ='$id'");
    header("location: lulus.php?siswa-diterima");
}
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            while ($rowSiswa = mysqli_fetch_assoc($siswa)) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="lulus.php?edit=<?php echo $rowSiswa['id'] ?>" class="<?php echo $rowSiswa['status'] == 3 ? 'btn btn-warning' : 'btn btn-success' ?>"><?php echo $rowSiswa['status'] == 3 ? 'Terima' : 'Wawancara' ?></a></td>
                                                    <td>| <a href=" https://wa.me/<?php echo $rowSiswa['id'] ?>" target="_blank"><i class='bx bxl-whatsapp'></i></a> | | <a href="lulus.php?edit=<?php echo $rowSiswa['id'] ?>"><i class='bx bx-edit'></i> |</a><a><a href=" details-siswa.php?edit=<?php echo $rowSiswa['id'] ?>"><i class='bx bx-dots-vertical'></i></a></td>
                                                    </td>
                                                </tr>
                                            <?php endwhile ?>
                                        </tbody>
